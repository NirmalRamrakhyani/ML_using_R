...
form_4 = as.formula('TOTAL.COST.TO.HOSPITAL~  AGE:PAST.MEDICAL.HISTORY.CODE')

reg_caret_model_2 <- caret:::train(form_3, data= reg_train_df,
...
interact_plot(reg_caret_model_2$finalModel, pred = AGE, modx = PAST.MEDICAL.HISTORY.CODE)
